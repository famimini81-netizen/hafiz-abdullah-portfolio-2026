  ...
  return (
    <section id="section-1" className="px-10 mt-20 md:mt-36 overflow-hidden ">
      ...
      <div className="md:flex">
        <div className=" md:text-right md:w-1/2 -translate-x-[70px] translate-y-[10px] max-h-[80vh] overflow-visible">
          <h1 className="text-[2.6rem] md:text-[5rem] font-bold leading-[0.95] m-0">
