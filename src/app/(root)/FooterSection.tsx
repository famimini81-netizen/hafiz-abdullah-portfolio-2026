export default function FooterSection() {
  return (
    <div className="min-h-screen mt-30 relative">
      <div className="md:flex">
        ...
        <div className="relative z-2 px-4 md:mr-10 mt-10 md:mt-60 pt-10 bg-gradient-to-b from-transparent to-black md:from-transparent md:to-transparent">
          ...
          <h5 className="border-b-2 border-red-500 w-fit py-2 font-bold mt-5 text-black/90">
      ...
      <div className=" relative z-2 bg-gradient-to-b from-transparent via-black/70 to-black w-full h-150 ">
        <div className="flex w-full h-full items-end pb-15">
          <div className=" w-full h-50 text-2xl px-4 flex flex-col md:flex-row gap-4 md:items-end md:justify-end md:gap-35 text-white/95">
            <p>Karachi .</p>
            <p>Pakistan .</p>
            <p>Open to Remote .</p>
          </div>
